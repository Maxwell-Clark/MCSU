...
const mindfulnessContent = (
  <>
    ...
    <List size="sm" mb="md">
      <List.Item><strong>Key traits:</strong> Awareness, non-judgment, focus on the present.</List.Item>
      <List.Item><strong>Example:</strong> Noticing the taste and texture of food while eating, without distraction.</List.Item>
    </List>
    <Text size="sm" mb="md">
    ...
    <List size="sm" mb="md">
      <List.Item><strong>Key traits:</strong> Intentional, often time-bound, uses specific techniques.</List.Item>
      <List.Item><strong>Example:</strong> Sitting for 10 minutes focusing on your breath to calm the mind.</List.Item>
    </List>
    <Text size="sm">
...
const distractionContent = (
  <>
    ...
    <List size="sm" spacing="md">
      <List.Item>
        <Text size="sm"><strong>Acknowledge Without Judgment:</strong> When your mind wanders, don't criticize yourself. Simply notice the distraction (e.g., a thought, sound, or sensation) and gently label it (e.g., "thinking" or "noise"). This builds awareness without frustration.</Text>
      </List.Item>
      <List.Item>
        <Text size="sm"><strong>Return to Your Anchor:</strong> Choose a focal point for your meditation, like your breath, a mantra, or a part of your body like the hands or feet. When you notice your mind drifting, calmly bring your attention back to this anchor.</Text>
      </List.Item>
      <List.Item>
        <Text size="sm"><strong>Reframe Distractions as Practice:</strong> View distractions as opportunities to strengthen your focus. Notice the thoughts as they arise, stay for a while and then pass away. After noticing the passing thoughts, just redirect your attention back to your anchor. Each time you redirect attention back to your anchor, you're training your mind, like exercising a muscle.</Text>
      </List.Item>
    </List>
  </>
);
